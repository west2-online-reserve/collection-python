...
def comp(a,b):
    return -1 if (not(a<52 and b<52) and a>b) or (a<52 and b<52 and (a%13>b%13 or (a%13==b%13 and a//13>b//13))) else 1
...
t4=set(All-t1-t2-t3)
player1,player2,player3,others=list(t1),list(t2),list(t3),list(t4)
